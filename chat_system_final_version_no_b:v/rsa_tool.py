...
def create_key_pairs(public_key_file:str=None, private_key_file:str=None):
...
def load_public_key(public_key_file: str, key:bytes = None):    
    with open(public_key_file, 'rb') as f:
        public_key = serialization.load_pem_public_key(f.read())
    return public_key


def load_public_key_from_bytes(key):
...
def load_private_key_from_bytes(private_key_data: str):
